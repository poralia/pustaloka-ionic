...
export class HttpService {
   ...
   * Create review
   */
  createReview(data: ICreateReview): Observable<any> {
    return this.httpClient.post(HTTPEnpoint.REVIEWS, data);
  }

  /**
   * Update reeview
   */
  updateReview(pid: number, data: ICreateReview): Observable<any> {
    return this.httpClient.put(`${HTTPEnpoint.REVIEWS}/${pid}`, data);
  }

  /**
   * Delete review
   */
  deleteReview(pid: number): Observable<any> {
    return this.httpClient.delete(`${HTTPEnpoint.REVIEWS}/${pid}`);
  }

  /**
   * Retrieve review
   */
  retrieveReview(pid: number): Observable<any> {
    return this.httpClient.get(`${HTTPEnpoint.REVIEWS}/${pid}`);
  }

  /**
   * Get reviews
   */
  getReviews(filter: IPostFilter): Observable<any> {
    let httpParams = new HttpParams();
    ...
    return this.httpClient.get(`${HTTPEnpoint.REVIEWS}`, { params: httpParams });
  }
